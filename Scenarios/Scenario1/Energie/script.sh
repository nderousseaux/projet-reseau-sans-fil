...
# 5 sender
Nb_sender=$((4+$Nb_sender))

RETOUR1=$(ssh wifi2023stras4@strasbourg.iot-lab.info "iotlab-experiment submit -d $Duree -l $Nb_coordinateur,archi=m3:at86rf231+site=strasbourg,$COORDINATOR,$PROFILE_NAME -l $Nb_sender,archi=m3:at86rf231+site=strasbourg,$SENDER,$PROFILE_NAME")
ID1=$(echo $RETOUR1 | grep -oP '(?<="id": )\d+')

ssh wifi2023stras4@strasbourg.iot-lab.info "iotlab-experiment wait -i $ID1"

# 10 sender
Nb_sender=$((5+$Nb_sender))

RETOUR2=$(ssh wifi2023stras4@strasbourg.iot-lab.info "iotlab-experiment submit -d $Duree -l $Nb_coordinateur,archi=m3:at86rf231+site=strasbourg,$COORDINATOR,$PROFILE_NAME -l $Nb_sender,archi=m3:at86rf231+site=strasbourg,$SENDER,$PROFILE_NAME")
ID2=$(echo $RETOUR2 | grep -oP '(?<="id": )\d+')

ssh wifi2023stras4@strasbourg.iot-lab.info "iotlab-experiment wait -i $ID2"
...
scp -r wifi2023stras4@strasbourg.iot-lab.info:~/.iot-lab/$ID1 .
scp -r wifi2023stras4@strasbourg.iot-lab.info:~/.iot-lab/$ID2 .
