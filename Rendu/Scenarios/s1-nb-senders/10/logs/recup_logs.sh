...
-l strasbourg,m3,41,$FIRMWARE_SENDER \
-l strasbourg,m3,42,$FIRMWARE_SENDER \
-l strasbourg,m3,43,$FIRMWARE_SENDER \
-l strasbourg,m3,44,$FIRMWARE_SENDER \
-l strasbourg,m3,45,$FIRMWARE_SENDER \
")
...
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-41.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender6.txt & " &
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-42.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender7.txt & " &
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-43.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender8.txt & " &
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-44.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender9.txt & " &
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-45.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender10.txt & " &
