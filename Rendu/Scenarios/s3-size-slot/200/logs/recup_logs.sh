...
-l strasbourg,m3,20,$FIRMWARE_COORDINATOR \
-l strasbourg,m3,21,$FIRMWARE_SENDER \
-l strasbourg,m3,22,$FIRMWARE_SENDER \
-l strasbourg,m3,23,$FIRMWARE_SENDER \
-l strasbourg,m3,24,$FIRMWARE_SENDER \
-l strasbourg,m3,25,$FIRMWARE_SENDER \
")
...
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-20.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/coordinator.txt & " &
ssh wifi2023stras4@strasbourg.iot-lab.info "nc m3-21.strasbourg.iot-lab.info 20000 > $RACINE/LOGS/$ID/sender1.txt & " &
